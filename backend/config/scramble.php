...
return [
    ...
    'info' => [
         ...
         */
        'description' => <<<'MD'
API da Mini Binance — trading simplificado de Bitcoin.

Autenticação via Sanctum (`Authorization: Bearer {token}`).
Rotas públicas: `register`, `login`, `refresh` e `market/btc`.
MD,
    ],
